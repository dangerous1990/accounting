 ...
 * 
 */
public class DayLedgerAdapter extends FragmentPagerAdapter implements
		IconPagerAdapter
{
	...
	public DayLedgerAdapter(FragmentManager fm)
	{
		super(fm);
	...
	public Fragment getItem(int arg0)
	{
		...
		return LedgerDayActivity.DayLedger.newInstance(lists.get(arg0));
	}
