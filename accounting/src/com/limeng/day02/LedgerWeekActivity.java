...
import com.limeng.day02.LedgerDayActivity.DayLedger;
import com.limeng.day02.adapter.RecordLsitViewAdapter;
import com.limeng.day02.adapter.WeekLedgerAdapter;
import com.limeng.entries.Record;
import com.limeng.service.RecordService;
import com.viewpagerindicator.TitlePageIndicator;

public class LedgerWeekActivity extends FragmentActivity
{
	private WeekLedgerAdapter dla;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		btn1.setOnClickListener(new OnClickListener()
		{
			...
			{
				LedgerWeekActivity.this.finish();
				
			}
		});
		tv_title.setText("按周流水");
		
		
		dla = new WeekLedgerAdapter(getSupportFragmentManager());
	...
	public static final class DayLedger extends android.support.v4.app.Fragment{
				...
				Bundle savedInstanceState)
		{
			...
			if(savedInstanceState!=null && savedInstanceState.containsKey(CREATE_KEY) ) 
			{
				...
				datas =  (ArrayList<Record>)recordService.getRecord(DateHelper.weekFirst(c), DateHelper.weekLast(c));
			}
