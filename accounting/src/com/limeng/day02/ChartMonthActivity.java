...
import com.limeng.day02.adapter.MonthChartAdapter;
import com.limeng.day02.adapter.WeekChartAdapter;
import com.limeng.service.RecordService;
import com.viewpagerindicator.TitlePageIndicator;

public class ChartMonthActivity extends FragmentActivity
{
	private MonthChartAdapter dla;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		btn1.setOnClickListener(new OnClickListener()
		{
			...
			{
				ChartMonthActivity.this.finish();
		...
		dla = new MonthChartAdapter(getSupportFragmentManager());
	...
	public static final class DayChart extends android.support.v4.app.Fragment{
		...
		public View initView()
		{
		   ...
		   // mRenderer.setStartAngle(90);
		    map = recordService.find_typeAndCost(DateHelper.monthFirst(c), DateHelper.monthLast(c));
		    bd = recordService.total(DateHelper.start(DateHelper.monthFirst(c)), DateHelper.end(DateHelper.monthLast(c)));
